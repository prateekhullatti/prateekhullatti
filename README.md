...
Backend-focused developer with hands-on experience in **Java, Spring Boot, and REST API development**. Currently working at **AVO Automation** as a Product Engineer — validating API workflows, automating reporting pipelines, and improving system reliability. Passionate about building clean, scalable backend systems and always leveling up in cloud & DevOps.
...
<img src="https://skillicons.dev/icons?i=java,spring,mysql,postgres,hibernate,react,js,html,css,tailwind,bootstrap,git,github,postman,docker,kubernetes,python,linux,vscode,idea&perline=10&theme=dark" />
